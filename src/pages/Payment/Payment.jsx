...
import DatePickerCom from "../../components/Dashboard/DatePickerCom";
...
import DatePickerPayment from "../../components/Payment/DatePickerPayment";
...
const Payment = () => {
    ...
    const { data, loading, error } = useSelector(
      (state) => state.transactionSingleDay
    );
        ...
        <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
          <Grid container spacing={2} marginBottom={2}>
            ...
            <Grid item xs={12} md={12} lg={2} align="right">
              ...
              <DatePickerPayment></DatePickerPayment>
            </Grid>
          </Grid>
...
// chore: note 2025-08-28T15:57:50
